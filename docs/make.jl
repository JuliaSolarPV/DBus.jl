...
DocMeta.setdocmeta!(DBus, :DocTestSetup, :(using DBus); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/JuliaSolarPV/DBus.jl/blob/{commit}{path}#{line}",
    sitename = "DBus.jl",
    format = Documenter.HTML(; canonical = "https://JuliaSolarPV.github.io/DBus.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaSolarPV/DBus.jl")
